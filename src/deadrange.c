...
/*   Updated: 2017/11/26 16:10:47 by dsaadia          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
				...
				size_t min)
{
	...
	if (!(where / 16) && gmv(map, where - 1))
		return (1);
	if (!(where % 16) && (gmv(map, where - 16) && (gmv(map, where - 15)
		|| gmv(map, where + 1))))
		return (1);
	if ((where % 16 == min - 1) && (gmv(map, where - 16)
		&& gmv(map, where - 1)))
		return (1);
	if ((where % 16 == min - 2) && gmv(map, where - 16) &&
